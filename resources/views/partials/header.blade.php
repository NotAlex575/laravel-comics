<header>
    <nav class="navbar navbar-expand-lg bg-white">
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                data-bs-target="#dcNavbar" aria-controls="dcNavbar" aria-expanded="false"
                aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>

            <!-- Links -->
            <div class="collapse navbar-collapse" id="dcNavbar">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link fw-bold" href="#">CHARACTERS</a></li>
                    <li class="nav-item"><a class="nav-link fw-bold" href="#">COMICS</a></li>
    ...
    <!-- Hero image sotto la navbar -->
    <div class="hero-header d-flex align-items-center" ></div>
</header>
